...
def printLinkedListInReverse(head: ImmutableListNode) -> None:
    # Print nodes in list reverse without modifying the list and only using the given APIs.
    stack = []
    curr = head
    ...
    stack = stack[::-1]
    return [ImmutableListNode.printValue(i) for i in stack]


# Alt solution, Slower


def printListReverse(head: ImmutableListNode):
